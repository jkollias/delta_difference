/* Errors */
/* TODO: Rewrite these using try catch */
...
/* Resources */
// <link href="delta-difference.css" rel="stylesheet" type="text/css">
...
function addCssFile(file_name){
     ...
     console.log("assets/css/"+file_name);
}
...
function deltaDifference(file,file_width){
    addCssFile("delta-difference.css");
